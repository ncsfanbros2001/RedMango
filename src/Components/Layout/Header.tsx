                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 w-100">
                            ...
                            {userData.role == SD_Roles.ADMIN ? (<li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li className="dropdown-item" onClick={() => navigate("menuItem/menuItemListPage")}
                                        style={{ cursor: "pointer" }}>
                                        Menu Items
                                    </li>
                                </ul>
                            ...
                            <div className="d-flex" style={{ marginLeft: "auto" }}>
                                ...
                                {userData.id && (<>
                                    <li className="nav-item">
                                        <button style={{ cursor: "pointer", background: "transparent", border: 0 }}
                                            className="nav-link active">Welcome, {userData.fullName}
                                        </button>
                                    </li>
                                    <li className="nav-item">
                                        <button style={{ border: "none", height: "40px", width: "100px" }} onClick={handleLogout}
                                ...
                                {!userData.id && (<>
                                    ...
                                    <li className="nav-item text-white">
                                        <NavLink style={{ border: "none", height: "40px", width: "100px" }}
                                            className="btn btn-success btn-outlined rounded-pill text-white mx-2" to="/login">
                                            Login
                                        </NavLink>
                                    </li>
                                </>)}
